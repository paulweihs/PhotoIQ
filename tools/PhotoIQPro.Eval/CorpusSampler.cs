...
/// <summary>
/// Samples photos from the PhotoIQ library for corpus building, stratified by decade.
...
public static class CorpusSampler
{
    ...
    /// <param name="libraryDbPath">Path to photoiq.db; defaults to %LOCALAPPDATA%\PhotoIQPro\photoiq.db.</param>
