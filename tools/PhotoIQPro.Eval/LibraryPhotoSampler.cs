...
/// <summary>
/// Queries the PhotoIQ app's SQLite library to sample photos that have AI descriptions
...
public static class LibraryPhotoSampler
{
    ...
    public static List<LibraryPhoto> Sample(int count, string? dbPath = null, string? promptVersion = null)
    {
        ...
        {
            Console.WriteLine($"[ERROR] PhotoIQ library not found: {dbPath}");
            Console.WriteLine("        Make sure PhotoIQ has been run at least once and has photos.");
            return [];
        }
