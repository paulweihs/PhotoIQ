...
public sealed class ClipTokenizer
{
    ...
    {
        // Cap input length before BPE processing to prevent excessive memory use on
        // pathological inputs — CLIP's context window is 77 tokens so anything beyond
        // ~10 KB of text will be truncated to the context limit anyway.
