...
public partial class SetupWindow : Window
{
    ...
    /// <summary>Opens SettingsWindow modally so the user can fix the Ollama URL, then re-checks.</summary>
    private void OnOpenSettings(object sender, RoutedEventArgs e)
    {
        ...
        // Re-run the setup check so the connection status reflects any URL changes.
        _ = _vm.RunAsync();
    }
