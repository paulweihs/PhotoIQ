...
public class PersonRepositoryTests : RepositoryTestBase
{
    ...
    public PersonRepositoryTests()
    {
        ...
        // People and Faces tables are created by EF Core model (PhotoWellContext).
...
public class OnThisDayAndFaceQueryTests : RepositoryTestBase
{
    ...
    public async Task GetFacesForPhotoAsync_ReturnsFacesForPhoto()
    {
        ...
        await _repo.AddAsync(photo);
        Db.Faces.Add(new PhotoWell.Core.Models.Face { MediaFileId = photo.Id, X = 0.1, Y = 0.1, Width = 0.2, Height = 0.2 });
        Db.Faces.Add(new PhotoWell.Core.Models.Face { MediaFileId = photo.Id, X = 0.5, Y = 0.1, Width = 0.2, Height = 0.2 });
        await Db.SaveChangesAsync();
    ...
    public async Task GetFacesForPhotoAsync_DoesNotReturnFacesFromOtherPhotos()
    {
        ...
        await _repo.AddAsync(p1);
        await _repo.AddAsync(p2);
        Db.Faces.Add(new PhotoWell.Core.Models.Face { MediaFileId = p1.Id, X = 0.1, Y = 0.1, Width = 0.2, Height = 0.2 });
        await Db.SaveChangesAsync();
    ...
    public async Task GetFacePhotoIdsForPersonAsync_ReturnsDistinctPhotoIds()
    {
        ...
        Db.Faces.Add(new PhotoWell.Core.Models.Face { MediaFileId = photo1.Id, PersonId = person.Id, X = 0.1, Y = 0.1, Width = 0.2, Height = 0.2 });
        Db.Faces.Add(new PhotoWell.Core.Models.Face { MediaFileId = photo1.Id, PersonId = person.Id, X = 0.6, Y = 0.1, Width = 0.2, Height = 0.2 });
        Db.Faces.Add(new PhotoWell.Core.Models.Face { MediaFileId = photo2.Id, PersonId = person.Id, X = 0.1, Y = 0.1, Width = 0.2, Height = 0.2 });
        await Db.SaveChangesAsync();
...
public class FaceBatchOperationsTests : RepositoryTestBase
{
    ...
    public async Task BatchAddFacesAsync_PersistsMultipleFaces()
    {
        ...
        var faces = new[]
        {
            new PhotoWell.Core.Models.Face { MediaFileId = photo.Id, X = 0.1, Y = 0.1, Width = 0.2, Height = 0.2 },
            new PhotoWell.Core.Models.Face { MediaFileId = photo.Id, X = 0.5, Y = 0.1, Width = 0.2, Height = 0.2 },
            new PhotoWell.Core.Models.Face { MediaFileId = photo.Id, X = 0.7, Y = 0.5, Width = 0.15, Height = 0.15 },
        };
    ...
    {
        await _repo.BatchAddFacesAsync(Array.Empty<PhotoWell.Core.Models.Face>());
        // Should not throw
    }
    ...
    public async Task BatchAddFacesAsync_SingleFace_Works()
    {
        ...
        var face = new PhotoWell.Core.Models.Face { MediaFileId = photo.Id, X = 0.3, Y = 0.3, Width = 0.2, Height = 0.2 };
    ...
    public async Task GetFacesByIdsAsync_RetrievesMultipleFaces()
    {
        ...
        var f1 = new PhotoWell.Core.Models.Face { MediaFileId = photo.Id, X = 0.1, Y = 0.1, Width = 0.2, Height = 0.2 };
        var f2 = new PhotoWell.Core.Models.Face { MediaFileId = photo.Id, X = 0.5, Y = 0.1, Width = 0.2, Height = 0.2 };
