...
public abstract class RepositoryTestBase : IDisposable
{
    ...
    protected readonly PhotoIQContext Db;

    protected RepositoryTestBase()
    {
        _dbPath = Path.Combine(Path.GetTempPath(), $"photoiq_test_{Guid.NewGuid():N}.db");
        Db = new PhotoIQContext(
            new DbContextOptionsBuilder<PhotoIQContext>()
