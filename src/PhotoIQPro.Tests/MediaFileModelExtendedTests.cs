...
public class AppSettingsConstantsTests
{
    ...
    public void ThumbnailsPath_ContainsAppName()
        => Assert.Contains("PhotoIQPro", AppSettings.ThumbnailsPath, StringComparison.OrdinalIgnoreCase);

    [Fact]
    public void ModelsPath_ContainsAppName()
        => Assert.Contains("PhotoIQPro", AppSettings.ModelsPath, StringComparison.OrdinalIgnoreCase);
}
