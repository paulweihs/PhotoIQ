...
public partial class MainWindow : Window
{
    ...
    private const string DragFormat = "PhotoIQ.PhotoIds";
        ...
        if (vm.Progress.IsRunning)
        {
            ...
            if (vm.Progress.IsQueueImport || vm.Progress.IsResumable)
            {
                ...
                message = $"{(vm.Progress.IsQueueImport ? "An import" : vm.Progress.Heading)} is currently running.\n\n" +
                          "If you exit now, progress will be saved and will automatically resume the next time you launch PhotoIQ Pro.\n\n" +
                          "Do you want to exit?";
            }
            else
            {
                title   = "Operation in Progress";
                message = $"{vm.Progress.Heading} is currently running.\n\n" +
