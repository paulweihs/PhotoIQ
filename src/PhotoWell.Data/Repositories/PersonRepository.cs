...
{
    private readonly PhotoWellContext _ctx;
    /// <summary>Initializes a new instance of the PersonRepository.</summary>
    /// <param name="ctx">The PhotoWellContext for database access.</param>
    public PersonRepository(PhotoWellContext ctx) => _ctx = ctx;
    ...
    public async Task SuppressPromptAsync(Guid personId)
    {
        await _ctx.People
